...
model.add(layers.LSTM(32, activation='relu',input_shape=(None,1),return_sequences=True,dropout=0.3))
model.add(layers.GRU(32, input_shape=(None,1),recurrent_dropout=0.3))
model.add(layers.Dense(1))

model.compile(optimizer='nadam', loss='mse')
history = model.fit(train_data,train_res,epochs=10,validation_data=(val_data, val_res))
